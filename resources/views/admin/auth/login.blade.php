...
@section('extra-css')
<link rel="stylesheet" href="{{ asset('admin-asset/login/css/login.css') }}">
@endsection
    ...
    <div class="container">
        <div class="card login-card">
            <div class="row no-gutters">
                <div class="col-md-5">
                    <img src="{{ asset('admin-asset/login/images/login.jpg') }}" alt="login" class="login-card-img">
                </div>
                <div class="col-md-7">
                    <div class="card-body">
                        <div class="brand-wrapper">
                            <img src="{{ asset('admin-asset/login/images/logo.svg') }}" alt="logo" class="logo">
                        ...
                        <nav class="login-card-footer-nav">
                            <a href="/" class="bg-black p-1 ">Return Home</a>
