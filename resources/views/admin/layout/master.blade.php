...
<head>
  ...
  <link rel="stylesheet"
    href="{{ asset('admin-asset/plugins/tempusdominus-bootstrap-4/css/tempusdominus-bootstrap-4.min.css') }}">
  <!-- iCheck -->
  ...
  <script src="https://kit.fontawesome.com/4f429c9890.js" crossorigin="anonymous"></script>
  @yield('extra-css')
</head>
<body class="hold-transition sidebar-mini layout-fixed">
  ...
  <!-- Tempusdominus Bootstrap 4 -->
  <script src="{{ asset('admin-asset/plugins/tempusdominus-bootstrap-4/js/tempusdominus-bootstrap-4.min.js') }}">
  </script>
  <!-- Summernote -->
