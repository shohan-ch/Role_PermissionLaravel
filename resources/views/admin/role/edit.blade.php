        ...
        <div class="card-body">
          ...
          <div class="form-group">
            ...
            <select class="form-control form-control" name="category">
              ...
              <option {{ $product->category =='website' ? 'selected' : ''  }} value="website">Website</option>
              <option {{ $product->category =='seo' ? 'selected' : ''  }} value="seo">SEO</option>
              <option {{ $product->category =='smm' ? 'selected' : ''  }} value="smm">SMM</option>
              <option {{ $product->category =='lb' ? 'selected' : ''  }} value="lb">LB</option>
              <option {{ $product->category =='sem' ? 'selected' : ''  }} value="sem">SEM</option>
              <option {{ $product->category =='lsm' ? 'selected' : ''  }} value="lsm">LSM</option>
            </select>
            @error('category')
            <p class="text-danger font-weight-bold">{{ $message }}</p>
            @enderror
          ...
          <div class="form-group">
            ...
            <input type="text" name="subcategory" class="form-control" id="exampleInputEmail1"
              value="{{ $product->subcategory }}" placeholder="Enter subcategory">
          </div>
